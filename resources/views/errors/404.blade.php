            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="/" class="nav-item nav-link {{ Request::is('/') ? 'active' : '' }}">Halaman Utama</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="/team" class="dropdown-item"><i class="fas fa-user-friends"></i> Tim Kami</a>
                    ...
                    <div class="dropdown text-end navbar-nav">
                        ...
                        <ul class="dropdown-menu text-small" style="transform: translateX(-3em)"
                            ...
                            <li><a class="dropdown-item" href="/Profile"><i class="fas fa-home"></i> Profil</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>Jalan Kemang Raya, Jakarta Selatan, Indonesia</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Your Site Name</a>,  Hak Cipta Dilindungi.
